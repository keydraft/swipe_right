                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    <Grid container spacing={4}>
                                        ...
                                        <Grid item xs={12} md={6}>
                                            ...
                                            {renderField("GST Percentage (%)", "Enter GST", false, "number", "gst")}
                                            
                                            <Box sx={{ mt: 1, p: 1, bgcolor: '#F9FAFB', borderRadius: '12px', border: '1px solid #F3F4FB' }}>
                                                <FormControlLabel
                                                    control={<Switch checked={formik.values.active} onChange={(e) => formik.setFieldValue("active", e.target.checked)} />}
                                                    label={formik.values.active ? "Active Status" : "Inactive Status"}
                                                    sx={{ '& .MuiTypography-root': { fontWeight: 600, fontSize: '14px', color: formik.values.active ? '#059669' : '#6B7280' } }}
                                                />
                                            </Box>
                                        </Grid>
