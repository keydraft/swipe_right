...
import { phoneRegex } from "@/utils/validationSchemas";
...
export default function TruckPage() {
    ...
    const truckValidationSchema = Yup.object({
        ...
        ownerName: Yup.string().when('ownershipType', {
            is: 'OWN',
            then: (schema) => schema.required("Owner name is required for owned trucks"),
    ...
    const handleEditTruck = (truck) => {
        ...
        setExistingFiles({
            rcFront: truck.rcFrontPath || null,
            rcBack: truck.rcBackPath || null,
            insurance: truck.insurancePath || null,
            permit: truck.permitPath || null,
            fc: truck.fcPath || null
        });
        setOpenModal(true);
        setShowSuccess(false);
    };
